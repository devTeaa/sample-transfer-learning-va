...
class AlexNet(nn.Module):
    ...
    def __init__(self, num_classes=1000):
        ...
        # self.transconv2d_6 = nn.ConvTranspose2d(32, 16, 4, stride=2, padding=0)
        # self.transconv2d_7 = nn.ConvTranspose2d(16, 3, 4, stride=2, padding=0)
